...
class WatermarkDetector(WatermarkBase):
    ...
    def _compute_p_value(self, z):
        ...
        return p_value # represting FP
    
    def _compute_fn_value(self,observed_count,T):
        expected_count = self.gamma
        numer = (T- observed_count) - (T - expected_count * T)
        denom = sqrt(T * expected_count * (1 - expected_count))
        z = numer / denom
        p_value = scipy.stats.norm.sf(z)
        return p_value
    ...
    def _score_sequence(
        ...
        print(self._compute_fn_value(green_token_count,num_tokens_scored))
        return score_dict
